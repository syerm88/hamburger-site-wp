        ...
        <div class="l-grid__main">
            <main class="l-main">
                <div class="p-mainvisual">
                        ...
                        <p class="c-title-sub__arciveseach-main">チーズバーガー</p>
                </div>
             ...
             <!-- c-card -->
                        <section class="c-card">
                                <figure class="c-inner__card">
                                    <img src="./img/archive-sub-sp.jpg" alt="">
                                    <figcaption class="c-card__article">
                                        ...
                                        <button class="c-card__button" href="#">詳しく見る</button>
                                    </figcaption>
                                </figure>
                        </section>
                        <section class="c-card">
                        ...
                        <p class="p-pagination">
                            <img class="p-pagination__navi" src="/img/paginavi.png" alt="">
                            <img class="p-pagination__number" src="/img/pagination.png" alt="">
                        </P>
                    </section>
            </main>
        </div>
